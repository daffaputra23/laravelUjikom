...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <button type="button" class="focus:outline-none ml-3 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 flex gap-2">Print to PDF
