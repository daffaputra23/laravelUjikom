...
<li class="flex items-center gap-1">
    <svg fill="currentColor" viewBox="0 0 20 20" class="text-gray-500 dark:text-gray-400 w-4 h-4" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 text-right">
                    <a href="/admin/pengaduan/detail/{{ $v->id_pengaduan }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Balas</a>
                </td>
            </tr>
            @endforeach
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
