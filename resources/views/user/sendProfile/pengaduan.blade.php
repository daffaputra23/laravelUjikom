...
<form action="/profile/kirimPengaduan" method="POST">
    ...
    <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 mb-3">Just write your detail of complaint, and get fix</p>

    <div class="mb-6 gri">
        <label for="judul_laporan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Complaint's Title</label>
        <input name="judul_laporan" type="text" id="judul_laporan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="complaint's title" required>
    </div>
    
      <label for="peng" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write your commplaint</label>
        <div id="peng" class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                <label for="isi_laporan" class="sr-only">Publish post</label>
                <textarea name="isi_laporan" id="isi_laporan" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
            </div>
        </div>
    ...
    <div class="flex gap-3 w-full">
        <div class="w-full">
            <label for="lokasi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Desc Location</label>
